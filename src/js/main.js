...
const movesOne = document.getElementById('moves-one');
const movesTwo = document.getElementById('moves-two');
const movesThre = document.getElementById('moves-thre');
const movesFour = document.getElementById('moves-four');
...
const getPokemonData = (pokemon) => {
    fetch(`https://pokeapi.co/api/v2/pokemon/${pokemon}`)
        ...
        .then((data) => {
            ...
            movesOne.innerHTML = data.moves[0].move.name;
            movesTwo.innerHTML = data.moves[1].move.name;
            movesThre.innerHTML = data.moves[2].move.name;
            movesFour.innerHTML = data.moves[3].move.name;
